...
Version  : 1.8.1
Release  : 59
URL      : https://github.com/flatpak/flatpak/releases/download/1.8.1/flatpak-1.8.1.tar.xz
Source0  : https://github.com/flatpak/flatpak/releases/download/1.8.1/flatpak-1.8.1.tar.xz
...
%prep
%setup -q -n flatpak-1.8.1
cd %{_builddir}/flatpak-1.8.1
%patch1 -p1
%patch2 -p1
...
unset no_proxy
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595558013
...
/usr/lib64/libflatpak.so.0.10801.0
